...
abstract class IOFactory
{
     ...
     *                                 IOFactory::READER_*.
     */
    public static function load(string $data, int $flags = 0, ?array $readers = null): Spreadsheet
    {
     ...
     *                                 IOFactory::READER_*.
     */
    public static function createReaderForFile(string $data, ?array $readers = null): IReader
    {
//        File::assertFile($filename);
        ...
        $guessedReader = self::getReaderTypeFromExtension($data);
