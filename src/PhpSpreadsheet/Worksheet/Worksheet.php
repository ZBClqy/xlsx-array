...
class Worksheet implements IComparable
{
    ...
    public function rangeToArray($range, $nullValue = null, $calculateFormulas = true, $formatData = true, $returnCellRef = false)
    {
        ...
        // Return
        return $this->test($minCol,$maxCol,$returnCellRef,$calculateFormulas,$minRow,$maxRow,$r);
    }

    private function  test($minCol,$maxCol,$returnCellRef,$calculateFormulas,$minRow,$maxRow,$r){
        $returnValue = [];
